"""
t-SNE Visualization for VL Features (GR00T Baseline)
...
# ============== 数据路径 ==============
DATA_PATH = '/dataset_rc_mm/chenby10@xiaopeng.com/paper_plot/data/tsne/vl_features_gr00t_baseline.npz'
...
# ============== 保存 ==============
plt.savefig(f'{OUTPUT_DIR}tsne_vl_features.png', 
            dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
plt.savefig(f'{OUTPUT_DIR}tsne_vl_features.pdf', 
            bbox_inches='tight', facecolor='white', edgecolor='none')

print(f"✓ Saved: tsne_vl_features.png/pdf")
