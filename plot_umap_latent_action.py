"""
UMAP Visualization for Latent Action Distribution
...
reducer = umap.UMAP(
    ...
    min_dist=0.1,         # 较小值使点更紧凑
    spread=1.0,
    random_state=42,
    metric='euclidean',
)
embedded = reducer.fit_transform(combined_pca)
...
# ============== 样式设置 ==============
ax.set_xlabel('UMAP Dimension 1', fontweight='bold', color='#333333')
ax.set_ylabel('UMAP Dimension 2', fontweight='bold', color='#333333')
...
# ============== 保存 ==============
plt.savefig(f'{OUTPUT_DIR}umap_latent_action.png', 
            dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
plt.savefig(f'{OUTPUT_DIR}umap_latent_action.pdf', 
            bbox_inches='tight', facecolor='white', edgecolor='none')

print(f"✓ Saved: umap_latent_action.png/pdf")
