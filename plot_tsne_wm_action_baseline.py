"""
t-SNE Visualization for World Model Baseline Action Embeddings
统一蓝黄配色 + 交替Z-order绘制
"""
...
# ============== 数据路径 ==============
DATA_PATH = '/dataset_rc_mm/chenby10@xiaopeng.com/Cosmos_predict_2.5/results/tsne_analysis/ac_multi_embodiment_no_latent_action_iter40000/ac_multi_embodiment_no_latent_action_crossattn_block_27_tsne_data.npz'
...
# ============== 保存 ==============
plt.savefig(f'{OUTPUT_DIR}tsne_wm_action_baseline.png', 
            dpi=300, bbox_inches='tight', facecolor='white', edgecolor='none')
plt.savefig(f'{OUTPUT_DIR}tsne_wm_action_baseline.pdf', 
            bbox_inches='tight', facecolor='white', edgecolor='none')

print(f"✓ Saved: tsne_wm_action_baseline.png/pdf")
